...
class SynthesisResult(BaseModel):
    executive_summary: list[str] = []   # 5-7 items (generated by dedicated LLM call)
    one_line_verdict: str = ""          # Generated by dedicated LLM call
    ...
    watchlist: list[str] = []           # Deprecated, kept for compatibility
