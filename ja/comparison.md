...
| Token Tracking | 入出力のトークン使用量カウント | ●●○ | ●●● | ●●● | ●●● | ●●● | ●●● |
| Latency Analysis | Span ごとおよびエンドツーエンドのレイテンシ測定 | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
| Replay | Dashboard 上でのステップバイステップの Trace 再生 | ●●○ | ●●● | ●●○ | ●●● | ●●○ | ●●● |
...
| Multi-step Reasoning | マルチターンなエージェント推論チェーンの可視化 | ●●○ | ●●● | ●●● | ●●● | ●●● | ●●● |
| Workflow Graph | エージェントワークフローの DAG またはグラフ表示 | ●●○ | ●●● | ●●● | ●●○ | ●●○ | ●●○ |
...
| Regression Detection | 品質の劣化（リグレッション）を自動検出 | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
...
| Dataset Versioning | Eval および学習用データセットのバージョン管理 | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
| Continuous Eval | 定期実行またはトリガーによる Eval 実行 | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
...
| 機能 | 説明 | W&B Weave | LangSmith | Langfuse | Braintrust | MLflow | Arize Phoenix |
|---|---|---|---|---|---|---|---|
| SDK Support | Python, JS/TS 等の公式 SDK | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
| Framework Integration | LangChain, LlamaIndex 等の組み込みサポート | ●●● | ●●● | ●●● | ●●● | ●●● | ●●● |
...
| CLI/Infra Integration | CLI ツールおよび Infrastructure-as-Code サポート | ●●○ | ●●● | ●●● | ●●● | ●●● | ●●● |
...
| RBAC | ロールベースのアクセス制御 | ●●○ | ●●● | ●●● | ●●● | ●●● | ●●● |
| PII Masking | 個人情報（PII）の自動検出とマスキング | ○○○ | ●●○ | ●●● | ●●○ | ●●○ | ○○○ |
| Audit Logs | ユーザーおよびシステムアクションの監査ログ | ○○○ | ●●● | ●●● | ●●○ | ●●○ | ○○○ |
